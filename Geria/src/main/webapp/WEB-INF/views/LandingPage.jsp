...
<head>
    ...
    <link rel="stylesheet" href="resources/myPersonalSiteProfile/css/bootstrap.min.css" />
    <link rel="stylesheet" type="text/css" href="resources/myPersonalSiteProfile/css/isotope.css" media="screen" />
    <link rel="stylesheet" href="resources/myPersonalSiteProfile/js/fancybox/jquery.fancybox.css" type="text/css" media="screen" />
    <link rel="stylesheet" type="text/css" href="resources/myPersonalSiteProfile/css/da-slider.css" />
    <!-- Owl Carousel Assets -->
    <link href="resources/myPersonalSiteProfile/js/owl-carousel/owl.carousel.css" rel="stylesheet">
   
   
     <link rel="stylesheet" href="<spring:theme code='stylesheet'/>" type="text/css" />
   
    <!-- Font Awesome -->
    <link href="resources/myPersonalSiteProfile/font/css/font-awesome.min.css" rel="stylesheet">
</head>
...
<body>
        ...
        <div class="container">
            <nav class="navbar navbar-inverse" role="navigation">
                <div class="navbar-header">
                    ...
                    <a href="#" class="navbar-brand scroll-top logo"><b>paGgy</b></a>
                </div>
                <!--/.navbar-header-->
                <div id="main-nav" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav" id="mainNav">
                        ...
                        <li><a href="goToRegistrationPage" class="scroll-link">Register</a></li>
    ...
    <section id="home">
        <div class="banner-container">
            <img src="resources/myPersonalSiteProfile/images/banner-bg.jpg" alt="banner" />
   ...
   <!--Portfolio-->
                        ...
                        <div class="portfolio-items isotopeWrapper clearfix" id="3">
                            ...
                            <article class="col-sm-4 isotopeItem webdesign">
                                <div class="portfolio-item">
                                    <img src="resources/myPersonalSiteProfile/images/portfolio/img1.jpg" alt="" />
                                    <div class="portfolio-desc align-center">
                                        <div class="folio-info">
                                            <a href="resources/myPersonalSiteProfile/resources/myPersonalSiteProfile/images/portfolio/img1.jpg" class="fancybox">
                                                <h5>Project Name</h5>
                            ...
                            <article class="col-sm-4 isotopeItem photography">
                                <div class="portfolio-item">
                                    <img src="resources/myPersonalSiteProfile/images/portfolio/img2.jpg" alt="" />
                                    <div class="portfolio-desc align-center">
                                        <div class="folio-info">
                            ...
                            <article class="col-sm-4 isotopeItem photography">
                                <div class="portfolio-item">
                                    <img src="resources/myPersonalSiteProfile/images/portfolio/img3.jpg" alt="" />
                                    <div class="portfolio-desc align-center">
                                        <div class="folio-info">
                                            <a href="resources/myPersonalSiteProfile/images/portfolio/img3.jpg" class="fancybox">
                                                <h5>Project Name</h5>
                                                <i class="fa fa-arrows-alt fa-2x"></i></a>
                                        </div>
                                    </div>
                            ...
                            <article class="col-sm-4 isotopeItem print">
                                <div class="portfolio-item">
                                    <img src="resources/myPersonalSiteProfile/images/portfolio/img4.jpg" alt="" />
                                    <div class="portfolio-desc align-center">
                                        <div class="folio-info">
                                            <a href="resources/myPersonalSiteProfile/images/portfolio/img4.jpg" class="fancybox">
                                                <h5>Project Name</h5>
                                                <i class="fa fa-arrows-alt fa-2x"></i></a>
                                        </div>
                                    </div>
                            ...
                            <article class="col-sm-4 isotopeItem photography">
                                <div class="portfolio-item">
                                    <img src="resources/myPersonalSiteProfile/images/portfolio/img5.jpg" alt="" />
                                    <div class="portfolio-desc align-center">
                                        <div class="folio-info">
                                            <a href="resources/myPersonalSiteProfile/images/portfolio/img5.jpg" class="fancybox">
                                                <h5>Project Name</h5>
                                                <i class="fa fa-arrows-alt fa-2x"></i></a>
                                        </div>
                                    </div>
                            ...
                            <article class="col-sm-4 isotopeItem webdesign">
                                <div class="portfolio-item">
                                    <img src="resources/myPersonalSiteProfile/images/portfolio/img6.jpg" alt="" />
                                    <div class="portfolio-desc align-center">
                                        <div class="folio-info">
                                            <a href="resources/myPersonalSiteProfile/images/portfolio/img6.jpg" class="fancybox">
                                                <h5>Project Name</h5>
                                                <i class="fa fa-arrows-alt fa-2x"></i></a>
                                        </div>
                                    </div>
                            ...
                            <article class="col-sm-4 isotopeItem print">
                                <div class="portfolio-item">
                                    <img src="resources/myPersonalSiteProfile/images/portfolio/img7.jpg" alt="" />
                                    <div class="portfolio-desc align-center">
                                        <div class="folio-info">
                                            <a href="resources/myPersonalSiteProfile/images/portfolio/img7.jpg" class="fancybox">
                                                <h5>Project Name</h5>
                                                <i class="fa fa-arrows-alt fa-2x"></i></a>
                                        </div>
                                    </div>
                            ...
                            <article class="col-sm-4 isotopeItem photography">
                                <div class="portfolio-item">
                                    <img src="resources/myPersonalSiteProfile/images/portfolio/img8.jpg" alt="" />
                                    <div class="portfolio-desc align-center">
                                        <div class="folio-info">
                                            <a href="resources/myPersonalSiteProfile/images/portfolio/img8.jpg" class="fancybox">
                                                <h5>Project Name</h5>
                                                <i class="fa fa-arrows-alt fa-2x"></i></a>
                                        </div>
                                    </div>
                            ...
                            <article class="col-sm-4 isotopeItem print">
                                <div class="portfolio-item">
                                    <img src="resources/myPersonalSiteProfile/images/portfolio/img9.jpg" alt="" />
                                    <div class="portfolio-desc align-center">
                                        <div class="folio-info">
                                            <a href="resources/myPersonalSiteProfile/images/portfolio/img9.jpg" class="fancybox">
                                                <h5>Project Name</h5>
                                                <i class="fa fa-arrows-alt fa-2x"></i></a>
                                        </div>
                                    </div>
    ...
    <section id="contactUs" class="page-section secPad">
        <div class="container">
            ...
            <div class="row mrgn30">
               ...
               <form:errors path="contactususer.*" />
                <form:form method="post" action="contactusfill" id="contactfrm" role="form">

                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="name">Name</label>
                            <input type="text" class="form-control" name="contactus_name" id="contactus_name" placeholder="Enter name">
                        </div>
                        <div class="form-group">
                            <label for="email">Email</label>
                            <input type="email" class="form-control" name="contactus_email" id="contactus_email" placeholder="Enter email" >
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="comments">Comments</label>
                            <textarea name="contactus_comment" class="form-control" id="contactus_comments" cols="3" rows="5" placeholder="Enter your message…" ></textarea>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 text-center">
                    Copyright 2018 | All Rights Reserved  -- Template by <a href="paragbhangale.com">paGgy</a>
                </div>
            </div>
            <!-- / .row -->
        </div>
    ...
    <script src="resources/myPersonalSiteProfile/js/modernizr-latest.js"></script>
    <script src="resources/myPersonalSiteProfile/js/jquery-1.8.2.min.js" type="text/javascript"></script>
    <script src="resources/myPersonalSiteProfile/js/bootstrap.min.js" type="text/javascript"></script>
    <script src="resources/myPersonalSiteProfile/js/jquery.isotope.min.js" type="text/javascript"></script>
    <script src="resources/myPersonalSiteProfile/js/fancybox/jquery.fancybox.pack.js" type="text/javascript"></script>
    <script src="resources/myPersonalSiteProfile/js/jquery.nav.js" type="text/javascript"></script>
    <script src="resources/myPersonalSiteProfile/js/jquery.cslider.js" type="text/javascript"></script>
    <script src="resources/myPersonalSiteProfile/js/custom.js" type="text/javascript"></script>
    <script src="resources/myPersonalSiteProfile/js/owl-carousel/owl.carousel.js"></script>
</body>
</html>
