...
<html lang="en">
    ...
    <link href="resources/AccountFF/css/emoji.css" rel="stylesheet">
...
<link href='//fonts.googleapis.com/css?family=Bitter:400,400italic,700' rel='stylesheet' type='text/css'>
  ...
  <body>
      ...
      <div class="timeline">
            ...
            <div class="row">
              ...
              <div class="col-md-9">
                <ul class="list-inline profile-menu">
                  ...
                  <li><a href="go_to_timelineAbout">About</a></li>
        ...
        <div id="page-contents">
          <div class="row">
           ...
           <%-- <%@ include file="/WEB-INF/views/AccountContent/postContent.jsp" %>
           --%>
           
           <%@ include file="/WEB-INF/views/AccountContent/Messages.jsp" %>
           <%@ include file="/WEB-INF/views/AccountInterface/Tags.jsp" %>
           <%@ include file="/WEB-INF/views/AccountContent/LatestbLogs.jsp" %>
          
            <div class="col-md-2 static sarahActivity">
    ...
    <footer id="footer">
      ...
      <div class="copyright">
        <p>Parag Bhangale 2018 Copyrighted</p>
      </div>
		</footer>
