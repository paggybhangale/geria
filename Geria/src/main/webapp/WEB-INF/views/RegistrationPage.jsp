  ...
  <div class="form_wrapper">
	<div class="form_container">
		...
		<div class="row clearfix">
			<div class="">
				<form:form id='register-form' autocomplete="off">
					<div class="row clearfix">
						<div class="col_half">
						...
						<div class="col_half">
							<div class="input_field"> 
								...
								<form:input type="text" name="Name" path="Name" placeholder="Name"  />
							</div>
						</div>
						<div class="col_half">
							<div class="input_field"> 
								...
								<form:input type="text" name="LastName" path="LastName" placeholder="LastName"  />
							</div>
						</div>
							<div class="col_half">
							<div class="input_field"> 
								...
								<form:input type="text" name="phoneno" path="phoneno" placeholder="phoneno"  />
							</div>
						</div>
					</div>
...
-->					<form:input id='submit-data' path="submitbutton" class="button" type="submit" value="Register" />
				</form:form>
			</div>
		</div>
	</div>
